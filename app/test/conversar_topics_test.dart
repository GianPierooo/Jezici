...
/// idioma del curso (en/pt/fr/it/de/nl), no en inglés fijo. Verifica que TODOS los
/// topics cubren los 6 idiomas con 3 frases clave, y que un idioma desconocido cae a inglés.
void main() {
  test('Conversar: cada topic cubre en/pt/fr/it/de/nl con modelo + 3 tips; fallback a en', () {
    expect(ConversarScreen.topics.length, 6);
    for (final t in ConversarScreen.topics) {
      for (final lang in const ['en', 'pt', 'fr', 'it', 'de', 'nl']) {
