# -*- coding: utf-8 -*-
"""LÉXICO Fase 1 (italiano) · verifica con CLIENTE REAL (JWT) que las palabras NUEVAS
...
def main():
    ...
    cid = q("select c.id from courses c join languages l on l.id=c.target_language_id where l.code='it'")[0]['id']
    tok, uid = V.mk_user('lexf1it@test.jezici.dev')
