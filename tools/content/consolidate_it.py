# -*- coding: utf-8 -*-
"""LÉXICO Fase 1 · ITALIANO — consolida candidates.json + los 5 review_out_*.json
...
def main():
    cands = json.load(open('_lexit/candidates.json', encoding='utf-8'))
    verd = {}
    for k in range(5):
        fp = '_lexit/review_out_%d.json' % k
    ...
    json.dump(final, open('_lexit/final.json', 'w', encoding='utf-8'), ensure_ascii=False, indent=1)
