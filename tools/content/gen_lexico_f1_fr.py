# -*- coding: utf-8 -*-
"""LÉXICO Fase 1 · FRANCÉS — autoría de vocabulario NUEVO (LEXICO_PLAN §3/§4).
...
uso: python gen_lexico_f1_en.py  → escribe la migración + _lexfr/audio_targets.json
"""
import json, re, uuid, unicodedata, os

NS = uuid.uuid5(uuid.NAMESPACE_URL, 'jezici/lexico_f1/fr')
CID = '20000000-0000-0000-0000-000000000003'
...
def main():
    taught = set(json.load(open('_lexfr/taught_fr.json', encoding='utf-8')))
    words = json.load(open('_lexfr/final.json', encoding='utf-8'))
    ...
    # ── migración ──
    out = ["-- LÉXICO Fase 1 · FRANCÉS — vocabulario NUEVO (LEXICO_PLAN §3/§4).",
    ...
    mig = '../../supabase/migrations/20260718120171_lexico_f1_fr.sql'
    open(mig, 'w', encoding='utf-8').write('\n'.join(out))
    json.dump(audio_targets, open('_lexfr/audio_targets.json', 'w', encoding='utf-8'), ensure_ascii=False)
