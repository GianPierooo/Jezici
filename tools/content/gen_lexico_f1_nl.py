# -*- coding: utf-8 -*-
"""LÉXICO Fase 1 · NEERLANDÉS — autoría de vocabulario NUEVO (LEXICO_PLAN §3/§4).
...
uso: python gen_lexico_f1_en.py  → escribe la migración + _lexnl/audio_targets.json
"""
import json, re, uuid, unicodedata, os

NS = uuid.uuid5(uuid.NAMESPACE_URL, 'jezici/lexico_f1/nl')
CID = '20000000-0000-0000-0000-000000000006'
...
def main():
    ...
    words = json.load(open('_lexnl/final.json', encoding='utf-8'))
    ...
    # ── migración ──
    out = ["-- LÉXICO Fase 1 · NEERLANDÉS — vocabulario NUEVO (LEXICO_PLAN §3/§4).",
    ...
    mig = '../../supabase/migrations/20260718120174_lexico_f1_nl.sql'
    open(mig, 'w', encoding='utf-8').write('\n'.join(out))
    json.dump(audio_targets, open('_lexnl/audio_targets.json', 'w', encoding='utf-8'), ensure_ascii=False)
